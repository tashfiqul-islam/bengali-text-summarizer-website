...
export default function ProjectOverview() {
  ...
  return (
    <div className='h-[600px] w-full bg-background text-foreground'>
      <Tabs
        defaultValue='model-architecture'
          ...
          <div className='h-full flex flex-col'>
            ...
            <TabsContent
              ...
              className={`mt-0 flex-1 flex flex-col ${
                activeTab === 'model-architecture' ? '' : 'hidden'
              }`}
            >
              ...
              <div
                className={`grid grid-cols-1 sm:grid-cols-2 gap-4 mb-6 ${
                  activeMobileSection === 'architecture' ? 'block' : 'hidden sm:block'
                }`}
              >
              ...
              <div
                className={`flex flex-col ${
                  activeMobileSection === 'initialization' ? 'block' : 'hidden sm:block'
                }`}
              >
                {/* Header */}
...
training_args = Seq2SeqTrainingArguments(
    ...
    save_safetensors=False
            ...
            <TabsContent
              value='model-tech-stack'
              className={`mt-0 ${activeTab === 'model-tech-stack' ? '' : 'hidden'}`}
            >
            ...
            <TabsContent
              value='website-tech-stack'
              className={`mt-0 ${activeTab === 'website-tech-stack' ? '' : 'hidden'}`}
            >
              <div className='grid grid-cols-3 sm:grid-cols-3 gap-2 sm:gap-4'>
